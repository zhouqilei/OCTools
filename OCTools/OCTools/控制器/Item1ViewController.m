...
- (void)viewDidLoad {
    ...
    self.data = @[@"自下向上弹出框",@"年月日选择器",@"年月选择器",@"地区选择器",@"图片轮播及文字轮播",@"星星评分",@"类似QQ的弹出菜单",@"可滚动菜单选择视图",@"类似QQ的自上而下的本地通知",@"简单的信息提示",@"使用UIActivityIndicatorView实现菊花效果",@"类似美团外卖的左边分类右边字内容的双列表",@"多图选择器",@"自定义Alert弹出视图",@"基础网页控制器",@"高德地图简单使用",@"百度地图简单使用"];
    
    self.tab = [[BaseTableView alloc]initWithFrame:CGRectMake(0, HeightForNagivationBarAndStatusBar, UI_SCREEN_WIDTH, UI_SCREEN_HEIGHT - HeightForNagivationBarAndStatusBar - TAB_BAR_HEIGHT) style:UITableViewStylePlain];
