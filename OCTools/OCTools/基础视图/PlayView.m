...
- (UIView *)toolView {
    if (!_toolView) {
        _toolView = [[UIView alloc]initWithFrame:CGRectMake(0, self.height - Tool_View_Height, self.width, Tool_View_Height)];
...
- (UISlider *)progress {
    if (!_progress) {
        _progress = [[UISlider alloc]initWithFrame:CGRectMake(40, 10, self.width - 100, 20)];
